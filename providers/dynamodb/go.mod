// A standalone module for the dynamodb provider. It pins runtime v0.59.1 via MVS
// over its own graph, independently of the core and other providers.
module loack-provider-dynamodb

go 1.25.5

require (
	github.com/aws-controllers-k8s/dynamodb-controller v0.0.0
	loack v0.0.0
)
